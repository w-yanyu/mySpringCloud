...
public class RemoteEnhancerScanRegistrar implements ImportBeanDefinitionRegistrar {
    @Override
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
            ...
            if (mapperScansAttrs != null) {
                ...
                for (int i = 0; i < annotations.length; ++i) {
                    this.registerBeanDefinitions(importingClassMetadata, annotations[i], registry, RemoteEnhancerScanRegistrar.generateBaseBeanName(importingClassMetadata, i));
                }
            }
